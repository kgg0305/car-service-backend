...
const table_fields = [
    'brand_name', 'sequence', 'nation', 'is_use', 'is_income', 'public_uri', 'room_uri', 'service_uri', 'deposit_uri', 'logo', 'created_at', 'created_by', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'is_deleted'
];
