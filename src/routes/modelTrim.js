...
//     `name` varchar(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '트림 통합 옵션이름',
//     `price` int(11) DEFAULT NULL COMMENT '트림 통합 옵션가격',
//     `detail` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '트림 통합 옵션세부내용',
...
const table_fields = [
    'model_id', 'name', 'price', 'detail', 'created_at', 'created_by', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'is_deleted'
];
